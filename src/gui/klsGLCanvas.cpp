...
void klsGLCanvas::wxOnMouseEvent(wxMouseEvent &event)
{
  ...
  else
  {
    ...
    else if (event.Leaving() && !isDragging(BUTTON_MIDDLE))
    { // Don't allow auto-scroll during pan-scrolling.
